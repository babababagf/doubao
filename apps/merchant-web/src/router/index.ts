...
const moduleRoutes: RouteRecordRaw[] = [
  { path: '', name: 'dashboard', component: () => import('@/views/DashboardView.vue'), meta: { title: '首页', moduleStatus: 'ready' } },
  { path: 'data-overview', name: 'data-overview', component: () => import('@/views/DataOverviewView.vue'), meta: { title: '数据总览', moduleStatus: 'ready' } },
  ...
  { path: 'doubao', name: 'doubao', redirect: { name: 'data-overview' } },
...
export const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: '/access/handoff',
      name: 'admin-handoff',
      component: () => import('@/views/AdminHandoffView.vue'),
      meta: { title: '安全进入客户后台' },
    },
    {
      path: '/',
